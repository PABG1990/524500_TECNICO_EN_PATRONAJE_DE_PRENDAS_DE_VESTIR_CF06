...
.curso-main-container.introduccion
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center
      .colsm-12.col-lg-12
        p.mb-5 En el siguiente video, el aprendiz podrá conocer el contenido del componente y preparar lo necesario para la adquisición de nuevas competencias.
    ...
    figure.mb-5(data-aos="zoom-in-left")
      ...
      figcaption Video: Requerimientos técnicos y prototipos - SENA 2024
